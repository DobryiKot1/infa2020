...
screen.fill(THECOLORS['azure1'])

circle(screen, pg.Color(THECOLORS['gold']), (200, 200), 150)
circle(screen, pg.Color(THECOLORS['black']), (200, 200), 150, 1)
circle(screen, pg.Color(THECOLORS['red']), (140, 160), 20)
circle(screen, pg.Color(THECOLORS['black']), (140, 160), 20, 1)
circle(screen, pg.Color(THECOLORS['red']), (260, 160), 20)
circle(screen, pg.Color(THECOLORS['black']), (260, 160), 20, 1)
circle(screen, pg.Color(THECOLORS['black']), (140, 160), 8)
circle(screen, pg.Color(THECOLORS['black']), (260, 160), 8)
polygon(screen, pg.Color(THECOLORS['black']),
        ((80, 73), (86, 66), (179, 158), (173, 164)))
polygon(screen, pg.Color(THECOLORS['black']),
        ((232, 156), (226, 145), (285, 96), (290, 104)))
rect(screen, pg.Color(THECOLORS['black']), (136, 272, 130, 40))
